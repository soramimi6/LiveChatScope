...
| [docs/ux-improvement-memo.md](docs/ux-improvement-memo.md) | UI/UX 改修メモ（実画面 feedback・Q1–Q8 方針決定） |
...
→ 次: UX polish（[ux-improvement-memo.md](docs/ux-improvement-memo.md)）+ Phase B。詳細: [handoff-current-state.md](docs/handoff-current-state.md)
