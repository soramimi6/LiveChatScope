...
| **UX-05** | `cursor/ux-g05-superchat-status-10cc` | スーパーチャット 0 件理由 API + UI | 🚧 PR #8 |
| **G-04** | `cursor/ux-g04-markdown-unify-10cc` | markdown-summary export / Stage 8 統一 | 🚧 PR #9 |
| **UX-23** | `cursor/ux-23-json-csv-export-10cc` | JSON v2 + ExportMenu 説明 + 収益 SC CSV | 🚧 PR #10 |
| **UX-06/24** | `cursor/ux-06-24-global-filter-10cc` | message_filter + refilter + GlobalFilterBar | 🚧 PR #11 |
| **UX-19** | `cursor/ux-19-session-ng-words-10cc` | セッション NG / 除外ユーザー UI | 🚧 PR 待ち |
...
| 設計 vs 実装の差分 | 同上 §2（partial 未使用 等）。**G-01 動画メタ・G-02 遷移・G-03 summary LIMIT・G-04 markdown-summary は解消済** |
