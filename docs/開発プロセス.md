...
| 進捗 | [第一弾チェックリスト.md](第一弾チェックリスト.md) |
| 判断方針 | 迷ったら **盛る** → 後で削る |
| UI 言語 | 日本語のみ |
...
| 1 | D-1 | `docs/ui-spec` | [UI仕様.md](UI仕様.md) | ✅ 完了 |
| 2 | D-2 | `docs/api-spec` | [API仕様.md](API仕様.md) | ✅ 完了 |
| 3 | D-3 | `docs/db-schema` | [DBスキーマ.md](DBスキーマ.md) | ✅ 完了 |
| 4 | D-4 | `docs/analysis-params` | [分析パラメータ.md](分析パラメータ.md) | ✅ 完了 |
| 5 | D-5 | `docs/development-process` | 本ドキュメント + [第一弾チェックリスト.md](第一弾チェックリスト.md) | ✅ 完了 |
| 6 | D-6 | `docs/test-acceptance` | [テスト受入.md](テスト受入.md) | ✅ 完了 |

詳細チェックリスト: [第一弾チェックリスト.md](第一弾チェックリスト.md)  
**別 PC 移行・現在地**: [引き継ぎ.md](引き継ぎ.md)
...
1. **計画**: [第一弾チェックリスト.md](第一弾チェックリスト.md) のタスク ID（W1–W12, D-1–D-6）と整合
