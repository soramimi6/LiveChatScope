...
> **作成日**: 2026-06-21  
> **根拠**: [ux-improvement-memo.md](ux-improvement-memo.md)（方針 Q1–Q8 確定済み）+ コードベース照合（`dev` ブランチ）  
...
| **実装ルール** | [ux-improvement-memo.md §0](ux-improvement-memo.md) — 明示指示までコード改修しない（本書は **計画のみ**） |
...
| ドキュメント | 用途 |
|--------------|------|
| [ux-improvement-memo.md](ux-improvement-memo.md) | 要望・方針・FAQ |
| [phase-1-checklist.md](phase-1-checklist.md) | 第一弾完了基準 |
| [analysis-params.md](analysis-params.md) | Stage 設定 |
| [api-spec.md](api-spec.md) | API 契約（改修時に更新） |
